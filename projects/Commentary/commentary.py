...
ax.set_xticklabels([])
ax.text(0.9, 0.9, r"$r_{E,B}=%.6f$"%r, ha="right", va="center", transform=ax.transAxes)
ax.set_ylim(-300, 300)
...
#     ax.set_ylim(-0.75, 0.75)
#     ax.plot(t/3600, dB, ls="-", lw=0.6, color="darkgreen", zorder=2)
#     ax.text(0.1, 0.9, tag[i], ha="left", va="center", transform=ax.transAxes)
#     ax = ax.twinx()
#     ax.set_ylabel(r"E(t) [mv/km]", color="b")
#     ax.plot(t/3600, Ets[i], ls="-", lw=0.6, color="b")
#     ax.set_xlim([0, 24])
#     ax.set_xticks([0, 6, 12, 18, 24])
#     r = np.corrcoef(dB, Ets[i])[0,1]
#     ax.text(0.9, 0.9, r"$r_{E,\frac{\partial B}{\partial t}}=%.6f$"%r, ha="right", va="center", transform=ax.transAxes)
#     if i!=1: 
#         ax.set_ylim(-300, 300)
#         ax.set_xticks([])
#     #else: 
...
ax.set_xticklabels([])
r = np.corrcoef(B, Ets[0])[0,1]
ax.text(0.9, 0.9, r"$r_{E,B}=%.6f$"%r, ha="right", va="center", transform=ax.transAxes, fontdict={"color":"r"})
r = np.corrcoef(dB, Ets[0])[0,1]
ax.text(0.9, 0.8, r"$r_{E,\frac{\partial B}{\partial t}}=%.6f$"%r, ha="right", va="center", transform=ax.transAxes, fontdict={"color":"darkgreen"})
ax.set_ylim(-300, 300)
