...
convertable_parameters = [
    dict(
        base_folder="10-11Feb1958/LowRes/",
        file_details=[
            dict(
                component="H",
                file="H[ESK].csv",
                ...
                x2_date=dt.datetime(1958, 2, 11, 9),
                xlim=[dt.datetime(1958, 2, 10, 20), dt.datetime(1958, 2, 11, 8)],
            ...
            dict(
                ...
                x1=38,
                x2=380,
                x1_date=dt.datetime(1958, 2, 10, 11, 10),
                x2_date=dt.datetime(1958, 2, 11, 9),
                xlim=[dt.datetime(1958, 2, 10, 20), dt.datetime(1958, 2, 11, 8)],
            ...
            #     xlim=[dt.datetime(1958, 2, 10, 18), dt.datetime(1958, 2, 11, 6)],
