...
def run_May2024_storm():
    ...
    if True:
        ...
        ax = ts.add_voltage(data, ylim=[-200,200], xlabel="Hours Since 10 May 2024, 12 UT")
...
def plot_magnetometer_datasets():
    ...
    datasets = [
        clean_B_fields([s], [[f"datasets/IM.{s.lower()}.min.txt"]])[s]
        for s in stns
    ]
